...
def train(env_id, num_timesteps, seed, method):
    ...
    with tf.Session(config=config):
        ...
        lr = 3e-4
        if method == "Attention":
            save_path = model_name + "_" + method + "_" + init_time
...
def main(*args, **kwargs):
    ...
    parser.add_argument('--attention', help='attention or not', type=str, default="StateAttention", choices=["Attention,NoAttention,StateAttention"])
